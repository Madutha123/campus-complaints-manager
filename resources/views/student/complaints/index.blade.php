...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('student.complaints.create') }}" class="rounded-lg bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:bg-black transition">Submit Complaint</a>
    </div>
    ...
    <form method="GET" action="{{ route('student.complaints.index') }}" class="rounded-xl border border-gray-200 bg-white p-4">
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                @forelse ($complaints as $complaint)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-gray-700">{{ $complaint->category?->name ?? 'Uncategorized' }}</td>
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('student.complaints.show', $complaint) }}" class="rounded-md border border-gray-300 px-3 py-1.5 text-xs font-semibold text-gray-700 hover:bg-gray-50">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-center text-gray-500">No complaints found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
